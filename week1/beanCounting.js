...
console.log(countBs("BOBBAIODbB"));


function countChar(myString, toFind) {

    var theText = myString;

    function countLetters(myString = theText) {
        var count = 0;
...
let resultFunction = countChar("Waleed", "a");
